...
public class PlayerLetterColumn5 extends Box {
    private Color color;
    ...
    public PlayerLetterColumn5(Color color, Dimension size) {
        this.color = color;
        bounds = new Rectangle(new Point(350, 0), size); // this is being used for calculating where the letter is
