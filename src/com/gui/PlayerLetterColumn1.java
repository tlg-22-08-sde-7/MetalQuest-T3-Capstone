...
public class PlayerLetterColumn1 extends Box {
    private Color color;
    ...
    public PlayerLetterColumn1(Color color, Dimension size) {
        this.color = color;
        bounds = new Rectangle(new Point(50, 0), size); // this is being used for calculating where the letter is
